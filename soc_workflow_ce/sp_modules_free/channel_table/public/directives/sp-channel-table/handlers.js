 ...
 * @param tableSelector
 */
module.exports = function (scope, $timeout, element, spCF, tableSelector) {
    ...
    // Remove selection from row when table redraw
    $(element).find(tableSelector).on('draw.dt', function () {
        $timeout(function () {
